...
//namespace http {
    ...
    public:
        ...
        void addGlobServlet(const std::string& uri, Servlet::ptr slt);              //添加模糊匹配servlet uri uri 模糊匹配 /sylar_*
        void addGlobServlet(const std::string& uri, FunctionServlet::callback cb);  //添加模糊匹配servlet uri uri 模糊匹配 /sylar_*
