...
int32_t FunctionWSServlet::onConnect(bin::http::HttpRequest::ptr header
                                     ,bin::http::WSSession::ptr session){
    if(m_onConnect){
...
int32_t FunctionWSServlet::onClose(bin::http::HttpRequest::ptr header
                                     ,bin::http::WSSession::ptr session){
    if(m_onClose){
...
int32_t FunctionWSServlet::handle(bin::http::HttpRequest::ptr header
