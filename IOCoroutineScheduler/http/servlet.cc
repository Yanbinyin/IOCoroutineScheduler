...
//namespace http {
    ...
    int32_t FunctionServlet::handle(bin::http::HttpRequest::ptr request
    ...
    ServletDispatch::ServletDispatch()
        ...
        m_default.reset(new NotFoundServlet("IOCoroutineScheduler/1.0"));
    }
    ...
    int32_t ServletDispatch::handle(bin::http::HttpRequest::ptr request
                , bin::http::HttpResponse::ptr response
                , bin::http::HttpSession::ptr session){
    ...
    int32_t NotFoundServlet::handle(bin::http::HttpRequest::ptr request
                    , bin::http::HttpResponse::ptr response
                    , bin::http::HttpSession::ptr session){
        response->setStatus(bin::http::HttpStatus::NOT_FOUND);
        response->setHeader("Server", "IOCoroutineScheduler/1.0.0");
