...
DESCRIPTION
    ...
    If the semaphore's value consequently becomes greater than zero,
        then another process or thread blocked in a sem_wait(3) call will be
woken up and proceed tolock the semaphore.

RETURN VALUE
    returns 0 on success; on error, the value of the semaphore is left
...
FiberSemaphore::~FiberSemaphore() { BIN_ASSERT(m_waiters.empty()); }
