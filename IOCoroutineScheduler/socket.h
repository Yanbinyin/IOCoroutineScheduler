...
namespace bin{
    ...
    */
    ...
    public:
        ...
        static Socket::ptr CreateTCP(bin::Address::ptr address);  //根据address的sa_family类型，创建IPv4/6 UNIX domain的TCP套接字对象
        static Socket::ptr CreateUDP(bin::Address::ptr address);  //根据address的sa_family类型，创建IPv4/6 UNIX domain的UDP套接字对象
    ...
    public:
        ...
        static SSLSocket::ptr CreateTCP(bin::Address::ptr address);
