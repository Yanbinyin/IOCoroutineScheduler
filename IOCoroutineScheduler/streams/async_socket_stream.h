#ifndef __BIN_STREAMS_ASYNC_SOCKET_STREAM_H__
#define __BIN_STREAMS_ASYNC_SOCKET_STREAM_H__
...
public:
    void setWorker(bin::IOManager* v){ m_worker = v;}
    bin::IOManager* getWorker() const { return m_worker;}

    void setIOManager(bin::IOManager* v){ m_iomanager = v;}
    bin::IOManager* getIOManager() const { return m_iomanager;}
...
protected:
    ...
    bool waitFiber();
protected:
    bin::FiberSemaphore m_sem;
    bin::FiberSemaphore m_waitSem;
    ...
    uint32_t m_sn;
    bool m_autoConnect;
    bin::Timer::ptr m_timer;
    bin::IOManager* m_iomanager;
    bin::IOManager* m_worker;
